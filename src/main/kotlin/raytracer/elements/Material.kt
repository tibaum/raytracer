 ...
 * @param ambientReflection background light or light reflected from other objects in the environment, a nonnegative value, typically between 0 an 1
 * @param diffuseReflection light reflected from a matte surface, a nonnegative value, typically between 0 an 1
 * @param specularReflection reflection of the light source itself, a nonnegative value, typically between 0 an 1
 * @param shininess controls size and tightness of the specular highlight, a nonnegative value, typically between 10 an 200
 */
data class Material(
