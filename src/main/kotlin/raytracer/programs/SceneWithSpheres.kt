...
fun main() {
    ...
    val floor = Sphere(
        transformationMatrix = Matrix.scaling(10.0, 0.01, 10.0),
        material = roomMaterial
    )

    val leftWall = Sphere(
        transformationMatrix = Matrix.translation(0.0, 0.0, 5.0)
    ...
    val world = World(pointLight, listOf(floor, leftWall, rightWall, middleSphere, rightSphere, leftSphere))
